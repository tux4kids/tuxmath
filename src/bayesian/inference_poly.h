...
inference_poly.h is part of "Tux, of Math Command", a.k.a. "tuxmath".
...
#ifndef INFERENCE_POLY_H
#define INFERENCE_POLY_H
...
void initial_net(Bayesian_Network);
...
void update_net(Bayesian_Network, int node_index, int node_value);
#endif
